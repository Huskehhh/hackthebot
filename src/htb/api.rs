...
pub async fn new_htbapi_instance(config: HTBAPIConfig) -> Result<HTBApiClient, Error> {
...
impl HTBApiClient {
    ...
    pub async fn get_user_activity(&self, user_id: i64) -> Result<UserActivity, Error> {
